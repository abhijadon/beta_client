                ...
                fields: [
                    {
                        ...
                        options: [
                            { value: 'General', label: 'General' },
                            { value: 'Full Stack Management', label: 'Full Stack Management' },
                            { value: 'Cloud Computing', label: 'Cloud Computing' },
                            { value: 'Data Analytics', label: 'Data Analytics' },
                ...
                fields: [
                    {
                        ...
                        options: [
                            ...
                            { value: 'ACCA', label: 'ACCA' },
                            { value: 'Digital Marketing', label: 'Digital Marketing' },
                            { value: 'Digital Enterprenureship', label: 'Digital Enterprenureship' },
                            { value: 'International Finanace', label: 'International Finanace' },,
                ...
                fields: [
                    {
                        ...
                        options: [
                            { value: 'General', label: 'General' },
                            { value: 'Public Policy & Governance', label: 'Public Policy & Governance' },
                            { value: 'Journalism and Mass Communication', label: 'Journalism and Mass Communication' },
                        ],
                    },
                    {
                ...
                fields: [
                    {
                        ...
                        options: [
                            { value: 'General', label: 'General' },
                            { value: 'Artificial Intelligence', label: 'Artificial Intelligence' },
                            { value: 'Cloud Technology & Information Technology', label: 'Cloud Technology & Information Technology' },
                ...
                fields: [
                    {
                        ...
                        type: 'select',
                        options: [
                            { value: 'Human Resource Management', label: 'General' },
                            { value: 'General', label: 'General' },
                            { value: 'General', label: 'General' },
                            { value: 'General', label: 'General' },
                            { value: 'General', label: 'General' },
                ...
                fields: [
                    {
                        ...
                        type: 'select',
                        options: [
                            { value: 'Cloud Technology & Information Security', label: 'Cloud Technology & Information Security' },
                            { value: 'Data Science', label: 'Data Science' },
                            { value: 'Artificial Intelligence', label: 'Artificial Intelligence' },
