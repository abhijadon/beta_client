...
export const OPEN_BROCHURE_BOX = 'OPEN_BROCHURE_BOX';
export const CLOSE_BROCHURE_BOX = 'CLOSE_BROCHURE_BOX';
export const COLLAPSE_BROCHURE_BOX = 'COLLAPSE_BROCHURE_BOX';